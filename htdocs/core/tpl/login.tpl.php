...
<input type="submit" class="button" value="&nbsp; <?php echo $langs->trans('Connection'); ?> &nbsp;" tabindex="5" />
    <br>
    <a class="button-google" style="margin-top: 20px; background-color: #0b419b !important; color:#FFFFFF,  text-decoration:none"  href="<?php echo MusoGoogleClient::googleLoginUrl(); ?>"><img src="/public/google.png" style="margin-left:5px;max-width:50%"></a>
</div>
...
if ($forgetpasslink || $helpcenterlink)
{
	...
	if ($helpcenterlink) {
		$url = DOL_URL_ROOT.'/public/ticket/index.php'.$moreparam;
